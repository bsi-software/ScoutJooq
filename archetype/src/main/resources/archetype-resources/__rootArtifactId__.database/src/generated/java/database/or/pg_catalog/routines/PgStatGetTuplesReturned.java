...
public class PgStatGetTuplesReturned extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 1235944501;
    ...
    public PgStatGetTuplesReturned() {
        super("pg_stat_get_tuples_returned", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
