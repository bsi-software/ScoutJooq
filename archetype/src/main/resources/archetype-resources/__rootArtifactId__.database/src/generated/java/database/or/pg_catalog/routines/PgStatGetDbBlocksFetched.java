...
public class PgStatGetDbBlocksFetched extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1580771787;
    ...
    public PgStatGetDbBlocksFetched() {
        super("pg_stat_get_db_blocks_fetched", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
