...
public class PgStatGetNumscans extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -768281974;
    ...
    public PgStatGetNumscans() {
        super("pg_stat_get_numscans", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
