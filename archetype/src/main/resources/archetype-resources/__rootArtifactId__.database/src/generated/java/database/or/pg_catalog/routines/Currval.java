...
public class Currval extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -72904679;
     ...
     */
    public Currval() {
        super("currval", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
