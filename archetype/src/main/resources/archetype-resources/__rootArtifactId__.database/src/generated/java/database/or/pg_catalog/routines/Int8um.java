...
public class Int8um extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 732895415;
     ...
     */
    public Int8um() {
        super("int8um", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
