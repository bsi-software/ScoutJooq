...
public class PgStatGetDbTuplesDeleted extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 935869424;
    ...
    public PgStatGetDbTuplesDeleted() {
        super("pg_stat_get_db_tuples_deleted", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
