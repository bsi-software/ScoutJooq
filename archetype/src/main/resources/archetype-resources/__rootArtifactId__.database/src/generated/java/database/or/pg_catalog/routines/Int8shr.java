...
public class Int8shr extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 853078464;
     ...
     */
    public Int8shr() {
        super("int8shr", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
