...
public class PgStatGetDbTuplesInserted extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 889979383;
    ...
    public PgStatGetDbTuplesInserted() {
        super("pg_stat_get_db_tuples_inserted", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
