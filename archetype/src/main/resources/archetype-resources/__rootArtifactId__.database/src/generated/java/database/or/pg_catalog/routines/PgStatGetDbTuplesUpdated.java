...
public class PgStatGetDbTuplesUpdated extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1735761650;
    ...
    public PgStatGetDbTuplesUpdated() {
        super("pg_stat_get_db_tuples_updated", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
