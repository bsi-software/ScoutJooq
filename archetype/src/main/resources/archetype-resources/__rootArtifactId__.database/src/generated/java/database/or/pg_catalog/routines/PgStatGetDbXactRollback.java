...
public class PgStatGetDbXactRollback extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -851092822;
    ...
    public PgStatGetDbXactRollback() {
        super("pg_stat_get_db_xact_rollback", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
