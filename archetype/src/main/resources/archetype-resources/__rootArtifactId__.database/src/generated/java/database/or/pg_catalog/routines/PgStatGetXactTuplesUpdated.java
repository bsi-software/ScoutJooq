...
public class PgStatGetXactTuplesUpdated extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 1776595114;
    ...
    public PgStatGetXactTuplesUpdated() {
        super("pg_stat_get_xact_tuples_updated", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
