...
public class Int81 extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1054189776;
     ...
     */
    public Int81() {
        super("int8", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
