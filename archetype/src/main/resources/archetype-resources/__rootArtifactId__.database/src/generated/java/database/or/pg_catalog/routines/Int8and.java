...
public class Int8and extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1363977643;
     ...
     */
    public Int8and() {
        super("int8and", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
