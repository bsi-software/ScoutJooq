...
public class PgStatGetBgwriterTimedCheckpoints extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 1951337764;
    ...
    public PgStatGetBgwriterTimedCheckpoints() {
        super("pg_stat_get_bgwriter_timed_checkpoints", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
