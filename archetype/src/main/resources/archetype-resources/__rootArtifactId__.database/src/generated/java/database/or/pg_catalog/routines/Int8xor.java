...
public class Int8xor extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -2133341603;
     ...
     */
    public Int8xor() {
        super("int8xor", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
