...
public class Int8not extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 1074350336;
     ...
     */
    public Int8not() {
        super("int8not", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
