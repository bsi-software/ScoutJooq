...
public class PgStatGetBgwriterBufWrittenClean extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 164900592;
    ...
    public PgStatGetBgwriterBufWrittenClean() {
        super("pg_stat_get_bgwriter_buf_written_clean", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
