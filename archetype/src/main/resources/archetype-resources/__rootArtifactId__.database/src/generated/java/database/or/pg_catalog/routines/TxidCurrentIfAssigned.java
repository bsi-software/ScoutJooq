...
public class TxidCurrentIfAssigned extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 330042052;
    ...
    public TxidCurrentIfAssigned() {
        super("txid_current_if_assigned", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
