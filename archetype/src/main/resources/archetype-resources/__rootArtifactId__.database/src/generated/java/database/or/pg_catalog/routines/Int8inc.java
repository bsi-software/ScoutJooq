...
public class Int8inc extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 1209946517;
     ...
     */
    public Int8inc() {
        super("int8inc", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
