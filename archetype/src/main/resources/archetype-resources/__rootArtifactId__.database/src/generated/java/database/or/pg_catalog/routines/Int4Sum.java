...
public class Int4Sum extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 1200182644;
     ...
     */
    public Int4Sum() {
        super("int4_sum", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
