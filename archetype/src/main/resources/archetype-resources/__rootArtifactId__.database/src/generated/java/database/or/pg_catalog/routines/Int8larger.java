...
public class Int8larger extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -979349069;
     ...
     */
    public Int8larger() {
        super("int8larger", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
