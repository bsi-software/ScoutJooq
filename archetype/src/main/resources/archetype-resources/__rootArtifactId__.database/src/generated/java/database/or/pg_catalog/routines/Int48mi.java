...
public class Int48mi extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1442636242;
     ...
     */
    public Int48mi() {
        super("int48mi", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
