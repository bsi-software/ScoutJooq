...
public class PgStatGetXactNumscans extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1830004765;
    ...
    public PgStatGetXactNumscans() {
        super("pg_stat_get_xact_numscans", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
