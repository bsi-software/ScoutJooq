...
public class PgStatGetXactTuplesFetched extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 2128328140;
    ...
    public PgStatGetXactTuplesFetched() {
        super("pg_stat_get_xact_tuples_fetched", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
