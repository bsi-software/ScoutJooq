...
public class PgStatGetDeadTuples extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1013101796;
    ...
    public PgStatGetDeadTuples() {
        super("pg_stat_get_dead_tuples", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
