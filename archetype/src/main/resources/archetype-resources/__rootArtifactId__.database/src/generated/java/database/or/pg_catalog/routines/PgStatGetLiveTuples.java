...
public class PgStatGetLiveTuples extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -541599820;
    ...
    public PgStatGetLiveTuples() {
        super("pg_stat_get_live_tuples", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
