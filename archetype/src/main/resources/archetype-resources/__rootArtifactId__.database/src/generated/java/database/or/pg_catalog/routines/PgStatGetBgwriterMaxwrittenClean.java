...
public class PgStatGetBgwriterMaxwrittenClean extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1251673220;
    ...
    public PgStatGetBgwriterMaxwrittenClean() {
        super("pg_stat_get_bgwriter_maxwritten_clean", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
