...
public class PgStatGetTuplesFetched extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1119499931;
    ...
    public PgStatGetTuplesFetched() {
        super("pg_stat_get_tuples_fetched", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
