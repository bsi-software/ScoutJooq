...
public class Sum2 extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 2013552877;
     ...
     */
    public Sum2() {
        super("sum", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
