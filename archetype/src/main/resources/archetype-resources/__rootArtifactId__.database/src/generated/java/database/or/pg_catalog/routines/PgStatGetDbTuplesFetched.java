...
public class PgStatGetDbTuplesFetched extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 121653040;
    ...
    public PgStatGetDbTuplesFetched() {
        super("pg_stat_get_db_tuples_fetched", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
