...
public class PgSequenceLastValue extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 1588959927;
    ...
    public PgSequenceLastValue() {
        super("pg_sequence_last_value", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
