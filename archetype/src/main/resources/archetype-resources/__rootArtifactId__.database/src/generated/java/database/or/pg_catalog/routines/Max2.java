...
public class Max2 extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -246057273;
     ...
     */
    public Max2() {
        super("max", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
