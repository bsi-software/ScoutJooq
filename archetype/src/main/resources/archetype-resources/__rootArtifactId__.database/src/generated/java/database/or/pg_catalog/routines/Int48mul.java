...
public class Int48mul extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 126081188;
     ...
     */
    public Int48mul() {
        super("int48mul", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
