...
public class PgStatGetDbConflictBufferpin extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 23254189;
    ...
    public PgStatGetDbConflictBufferpin() {
        super("pg_stat_get_db_conflict_bufferpin", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
