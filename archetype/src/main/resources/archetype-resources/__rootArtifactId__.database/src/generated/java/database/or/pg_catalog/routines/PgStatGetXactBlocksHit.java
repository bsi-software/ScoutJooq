...
public class PgStatGetXactBlocksHit extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1608391977;
    ...
    public PgStatGetXactBlocksHit() {
        super("pg_stat_get_xact_blocks_hit", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
