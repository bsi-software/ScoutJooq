...
public class Int8div extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 1533225801;
     ...
     */
    public Int8div() {
        super("int8div", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
