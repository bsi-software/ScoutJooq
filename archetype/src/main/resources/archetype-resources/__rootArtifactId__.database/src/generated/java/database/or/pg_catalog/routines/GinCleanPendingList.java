...
public class GinCleanPendingList extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 1610115255;
    ...
    public GinCleanPendingList() {
        super("gin_clean_pending_list", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
