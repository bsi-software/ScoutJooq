...
public class PgStatGetDbBlocksHit extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 2067992635;
    ...
    public PgStatGetDbBlocksHit() {
        super("pg_stat_get_db_blocks_hit", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
