...
public class Int8mul extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 1302429679;
     ...
     */
    public Int8mul() {
        super("int8mul", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
