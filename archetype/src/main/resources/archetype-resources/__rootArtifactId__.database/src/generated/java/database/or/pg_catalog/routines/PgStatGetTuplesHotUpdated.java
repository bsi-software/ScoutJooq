...
public class PgStatGetTuplesHotUpdated extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 858183657;
    ...
    public PgStatGetTuplesHotUpdated() {
        super("pg_stat_get_tuples_hot_updated", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
