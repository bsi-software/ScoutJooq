...
public class Int8or extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -300707917;
     ...
     */
    public Int8or() {
        super("int8or", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
