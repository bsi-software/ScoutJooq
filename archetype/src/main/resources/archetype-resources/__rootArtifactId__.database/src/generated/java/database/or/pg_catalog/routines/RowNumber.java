...
public class RowNumber extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -635995320;
     ...
     */
    public RowNumber() {
        super("row_number", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
