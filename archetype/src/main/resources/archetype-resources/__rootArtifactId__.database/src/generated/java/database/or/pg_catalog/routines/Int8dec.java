...
public class Int8dec extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -587066127;
     ...
     */
    public Int8dec() {
        super("int8dec", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
