...
public class RegrCount extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 1470523763;
     ...
     */
    public RegrCount() {
        super("regr_count", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
