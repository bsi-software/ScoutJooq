...
public class PgStatGetAnalyzeCount extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1721131570;
    ...
    public PgStatGetAnalyzeCount() {
        super("pg_stat_get_analyze_count", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
