...
public class Int82mul extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 1861046048;
     ...
     */
    public Int82mul() {
        super("int82mul", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
