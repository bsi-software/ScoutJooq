...
public class PgStatGetTuplesUpdated extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 655941447;
    ...
    public PgStatGetTuplesUpdated() {
        super("pg_stat_get_tuples_updated", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
