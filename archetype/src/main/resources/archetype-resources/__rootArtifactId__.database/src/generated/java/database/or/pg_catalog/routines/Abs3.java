...
public class Abs3 extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1019735953;
     ...
     */
    public Abs3() {
        super("abs", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
