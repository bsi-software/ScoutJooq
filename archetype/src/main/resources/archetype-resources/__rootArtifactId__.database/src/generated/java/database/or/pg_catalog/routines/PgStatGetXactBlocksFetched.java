...
public class PgStatGetXactBlocksFetched extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1468263983;
    ...
    public PgStatGetXactBlocksFetched() {
        super("pg_stat_get_xact_blocks_fetched", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
