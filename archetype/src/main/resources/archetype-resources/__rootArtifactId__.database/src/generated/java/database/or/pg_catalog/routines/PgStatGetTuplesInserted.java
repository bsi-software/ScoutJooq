...
public class PgStatGetTuplesInserted extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1645971138;
    ...
    public PgStatGetTuplesInserted() {
        super("pg_stat_get_tuples_inserted", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
