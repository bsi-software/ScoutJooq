...
public class PgStatGetAutovacuumCount extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -406084652;
    ...
    public PgStatGetAutovacuumCount() {
        super("pg_stat_get_autovacuum_count", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
