...
public class PgStatGetFunctionCalls extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1452551410;
    ...
    public PgStatGetFunctionCalls() {
        super("pg_stat_get_function_calls", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
