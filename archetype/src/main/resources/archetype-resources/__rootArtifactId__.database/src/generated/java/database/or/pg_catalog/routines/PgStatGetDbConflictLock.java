...
public class PgStatGetDbConflictLock extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 681952607;
    ...
    public PgStatGetDbConflictLock() {
        super("pg_stat_get_db_conflict_lock", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
