...
public class Int2Sum extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 2065560884;
     ...
     */
    public Int2Sum() {
        super("int2_sum", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
