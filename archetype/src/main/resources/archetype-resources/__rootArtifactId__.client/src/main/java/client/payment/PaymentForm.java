...
#set( $symbol_pound = '#' )
#set( $symbol_escape = '\' )
package ${package}.client.payment;
...
import ${package}.client.document.AbstractDocumentTable;
import ${package}.client.payment.PaymentForm.MainBox.PaymentBox;
import ${package}.client.payment.PaymentForm.MainBox.PaymentBox.CancelButton;
import ${package}.client.payment.PaymentForm.MainBox.PaymentBox.DescriptionBox;
import ${package}.client.payment.PaymentForm.MainBox.PaymentBox.DescriptionBox.DateField;
import ${package}.client.payment.PaymentForm.MainBox.PaymentBox.DescriptionBox.UsageField;
import ${package}.client.payment.PaymentForm.MainBox.PaymentBox.InformationBox;
import ${package}.client.payment.PaymentForm.MainBox.PaymentBox.InformationBox.DocumentTableField;
import ${package}.client.payment.PaymentForm.MainBox.PaymentBox.InformationBox.NoteField;
import ${package}.client.payment.PaymentForm.MainBox.PaymentBox.MoneyBox;
import ${package}.client.payment.PaymentForm.MainBox.PaymentBox.MoneyBox.AmountField;
import ${package}.client.payment.PaymentForm.MainBox.PaymentBox.MoneyBox.SharedField;
import ${package}.client.payment.PaymentForm.MainBox.PaymentBox.OkButton;
import ${package}.client.payment.PaymentForm.MainBox.PaymentBox.PaymentIdField;
import ${package}.client.payment.PaymentForm.MainBox.PaymentBox.TechnicalBox;
import ${package}.client.payment.PaymentForm.MainBox.PaymentBox.TechnicalBox.ActiveField;
import ${package}.client.payment.PaymentForm.MainBox.PaymentBox.TechnicalBox.UserIdField;
import ${package}.client.user.UserLookupCall;
import ${package}.shared.payment.CreatePaymentPermission;
...
import ${package}.shared.payment.UpdatePaymentPermission;
