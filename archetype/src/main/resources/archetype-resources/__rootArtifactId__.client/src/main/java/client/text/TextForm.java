...
import ${package}.client.text.TextForm.MainBox.CancelButton;
import ${package}.client.text.TextForm.MainBox.OkButton;
import ${package}.client.text.TextForm.MainBox.TopBox;
import ${package}.client.text.TextForm.MainBox.TopBox.HasTextFilterField;
import ${package}.client.text.TextForm.MainBox.TopBox.KeyField;
import ${package}.client.text.TextForm.MainBox.TopBox.LocaleFilterField;
import ${package}.client.text.TextForm.MainBox.TopBox.TranslationTableField;
import ${package}.client.text.TextForm.MainBox.TopBox.TranslationTableField.Table;
import ${package}.shared.code.LocaleCodeType;
import ${package}.shared.text.ITextService;
import ${package}.shared.text.UpdateTranslationPermission;
