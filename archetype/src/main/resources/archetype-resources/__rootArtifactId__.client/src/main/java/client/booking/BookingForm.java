...
#set( $symbol_pound = '#' )
#set( $symbol_escape = '\' )
package ${package}.client.booking;
...
import ${package}.client.booking.BookingForm.MainBox.BookingBox;
import ${package}.client.booking.BookingForm.MainBox.BookingBox.CancelButton;
import ${package}.client.booking.BookingForm.MainBox.BookingBox.DescriptionBox;
import ${package}.client.booking.BookingForm.MainBox.BookingBox.DescriptionBox.DescriptionField;
import ${package}.client.booking.BookingForm.MainBox.BookingBox.DescriptionBox.UserIdField;
import ${package}.client.booking.BookingForm.MainBox.BookingBox.InformationBox;
import ${package}.client.booking.BookingForm.MainBox.BookingBox.InformationBox.DocumentTableField;
import ${package}.client.booking.BookingForm.MainBox.BookingBox.InformationBox.NoteField;
import ${package}.client.booking.BookingForm.MainBox.BookingBox.OkButton;
import ${package}.client.booking.BookingForm.MainBox.BookingBox.TechnicalBox;
import ${package}.client.booking.BookingForm.MainBox.BookingBox.TechnicalBox.ActiveField;
import ${package}.client.booking.BookingForm.MainBox.BookingBox.TechnicalBox.BookingIdField;
import ${package}.client.booking.BookingForm.MainBox.BookingBox.TimeBox;
import ${package}.client.booking.BookingForm.MainBox.BookingBox.TimeBox.DateFromField;
import ${package}.client.booking.BookingForm.MainBox.BookingBox.TimeBox.DateToField;
...
import ${package}.shared.booking.CreateBookingPermission;
import ${package}.shared.booking.IBookingService;
import ${package}.shared.booking.UpdateBookingPermission;
