...
import ${package}.server.ServerProperties.SuperUserSubjectProperty;
...
public class SuperUserRunContextProducer extends ServerRunContextProducer {
   ...
   * <p>
   * This method delegates to {@link ${symbol_pound}produce()}, meaning that the subject specified is ignored.
   *
   * @param subject
   *          is ignored, and {@link SuperUserRunContextProducer${symbol_pound}getSubject()} used instead.
   * @see ${symbol_pound}produce()
   */
  @Override
