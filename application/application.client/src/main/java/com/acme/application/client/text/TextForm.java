...
import com.acme.application.client.text.TextForm.MainBox.CancelButton;
import com.acme.application.client.text.TextForm.MainBox.OkButton;
import com.acme.application.client.text.TextForm.MainBox.TopBox;
import com.acme.application.client.text.TextForm.MainBox.TopBox.HasTextFilterField;
import com.acme.application.client.text.TextForm.MainBox.TopBox.KeyField;
import com.acme.application.client.text.TextForm.MainBox.TopBox.LocaleFilterField;
import com.acme.application.client.text.TextForm.MainBox.TopBox.TranslationTableField;
import com.acme.application.client.text.TextForm.MainBox.TopBox.TranslationTableField.Table;
import com.acme.application.shared.code.LocaleCodeType;
import com.acme.application.shared.text.ITextService;
import com.acme.application.shared.text.UpdateTranslationPermission;
