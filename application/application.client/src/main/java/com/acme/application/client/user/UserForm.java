...
import com.acme.application.client.user.UserForm.MainBox.AccountLockedField;
import com.acme.application.client.user.UserForm.MainBox.CancelButton;
import com.acme.application.client.user.UserForm.MainBox.OkButton;
import com.acme.application.client.user.UserForm.MainBox.PasswordField;
import com.acme.application.client.user.UserForm.MainBox.RoleTableField;
import com.acme.application.client.user.UserForm.MainBox.UserBox;
import com.acme.application.shared.user.CreateUserPermission;
import com.acme.application.shared.user.IUserService;
import com.acme.application.shared.user.UpdateUserPermission;
