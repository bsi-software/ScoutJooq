...
public class Int8decAny extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -536263164;
     ...
     */
    public Int8decAny() {
        super("int8dec_any", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
