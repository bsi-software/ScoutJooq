...
public class Int8up extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 424627464;
     ...
     */
    public Int8up() {
        super("int8up", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
