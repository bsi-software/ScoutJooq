...
public class Int8pl extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -2059484653;
     ...
     */
    public Int8pl() {
        super("int8pl", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
