...
public class PgStatGetBlocksFetched extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1392884992;
    ...
    public PgStatGetBlocksFetched() {
        super("pg_stat_get_blocks_fetched", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
