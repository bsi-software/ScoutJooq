...
public class PgStatGetAutoanalyzeCount extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 1133561147;
    ...
    public PgStatGetAutoanalyzeCount() {
        super("pg_stat_get_autoanalyze_count", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
