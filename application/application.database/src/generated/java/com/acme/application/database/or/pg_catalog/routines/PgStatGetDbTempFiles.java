...
public class PgStatGetDbTempFiles extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -849292919;
    ...
    public PgStatGetDbTempFiles() {
        super("pg_stat_get_db_temp_files", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
