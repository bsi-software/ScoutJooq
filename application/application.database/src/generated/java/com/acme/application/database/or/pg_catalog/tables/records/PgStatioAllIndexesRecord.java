...
public class PgStatioAllIndexesRecord extends TableRecordImpl<PgStatioAllIndexesRecord> implements Record7<Long, Long, String, String, String, BigDecimal, BigDecimal> {

    private static final long serialVersionUID = -211807732;
     ...
     */
    @Override
    public PgStatioAllIndexesRecord value6(BigDecimal value) {
     ...
     */
    @Override
    public PgStatioAllIndexesRecord value7(BigDecimal value) {
        setIdxBlksHit(value);
        return this;
    }
     ...
     */
    @Override
    public PgStatioAllIndexesRecord values(Long value1, Long value2, String value3, String value4, String value5, BigDecimal value6, BigDecimal value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PgStatioAllIndexesRecord(Long relid, Long indexrelid, String schemaname, String relname, String indexrelname, BigDecimal idxBlksRead, BigDecimal idxBlksHit) {
        super(PgStatioAllIndexes.PG_STATIO_ALL_INDEXES);
