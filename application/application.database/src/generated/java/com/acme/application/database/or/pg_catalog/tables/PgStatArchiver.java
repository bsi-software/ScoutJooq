...
import com.acme.application.database.or.pg_catalog.tables.records.PgStatArchiverRecord;
...
public class PgStatArchiver extends TableImpl<PgStatArchiverRecord> {
    ...
    private static final long serialVersionUID = 1870338159;
     ...
     */
    public final TableField<PgStatArchiverRecord, BigDecimal> ARCHIVED_COUNT = createField("archived_count", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());
     ...
     */
    public final TableField<PgStatArchiverRecord, BigDecimal> FAILED_COUNT = createField("failed_count", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());
