...
public class PgStatGetArchiver extends AbstractRoutine<java.lang.Void> {
    ...
    private static final long serialVersionUID = -1563122052;

    /**
     * The parameter <code>pg_catalog.pg_stat_get_archiver.archived_count</code>.
     */
    public static final Parameter<BigDecimal> ARCHIVED_COUNT = createParameter("archived_count", org.jooq.impl.SQLDataType.BIGINT, false, false, new LongConverter());
     ...
     */
    public static final Parameter<BigDecimal> FAILED_COUNT = createParameter("failed_count", org.jooq.impl.SQLDataType.BIGINT, false, false, new LongConverter());
