...
public class Int28mul extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 633821832;
     ...
     */
    public Int28mul() {
        super("int28mul", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
