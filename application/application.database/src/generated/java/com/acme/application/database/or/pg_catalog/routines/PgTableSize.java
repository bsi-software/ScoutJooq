...
public class PgTableSize extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -953854699;
     ...
     */
    public PgTableSize() {
        super("pg_table_size", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
