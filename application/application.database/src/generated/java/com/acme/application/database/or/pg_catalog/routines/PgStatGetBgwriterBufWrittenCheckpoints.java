...
public class PgStatGetBgwriterBufWrittenCheckpoints extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 1914733680;
    ...
    public PgStatGetBgwriterBufWrittenCheckpoints() {
        super("pg_stat_get_bgwriter_buf_written_checkpoints", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
