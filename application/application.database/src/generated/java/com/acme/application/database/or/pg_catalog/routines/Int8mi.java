...
public class Int8mi extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1490534893;
     ...
     */
    public Int8mi() {
        super("int8mi", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
