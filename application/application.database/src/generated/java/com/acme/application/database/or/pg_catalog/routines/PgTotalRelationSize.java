...
public class PgTotalRelationSize extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1773739081;
    ...
    public PgTotalRelationSize() {
        super("pg_total_relation_size", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
