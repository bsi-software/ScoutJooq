...
public class PgStatGetDbConflictAll extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 171341281;
    ...
    public PgStatGetDbConflictAll() {
        super("pg_stat_get_db_conflict_all", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
