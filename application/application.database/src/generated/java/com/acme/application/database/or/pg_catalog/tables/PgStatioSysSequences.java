...
import com.acme.application.database.or.pg_catalog.tables.records.PgStatioSysSequencesRecord;
...
public class PgStatioSysSequences extends TableImpl<PgStatioSysSequencesRecord> {
    ...
    private static final long serialVersionUID = -192806622;
     ...
     */
    public final TableField<PgStatioSysSequencesRecord, BigDecimal> BLKS_READ = createField("blks_read", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_statio_sys_sequences.blks_hit</code>.
     */
    public final TableField<PgStatioSysSequencesRecord, BigDecimal> BLKS_HIT = createField("blks_hit", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());
