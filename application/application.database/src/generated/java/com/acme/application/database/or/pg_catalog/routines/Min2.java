...
public class Min2 extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1651708847;
     ...
     */
    public Min2() {
        super("min", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
