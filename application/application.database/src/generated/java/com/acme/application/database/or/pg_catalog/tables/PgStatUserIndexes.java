...
import com.acme.application.database.or.pg_catalog.tables.records.PgStatUserIndexesRecord;
...
public class PgStatUserIndexes extends TableImpl<PgStatUserIndexesRecord> {
    ...
    private static final long serialVersionUID = 511158702;
     ...
     */
    public final TableField<PgStatUserIndexesRecord, BigDecimal> IDX_SCAN = createField("idx_scan", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_stat_user_indexes.idx_tup_read</code>.
     */
    public final TableField<PgStatUserIndexesRecord, BigDecimal> IDX_TUP_READ = createField("idx_tup_read", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_stat_user_indexes.idx_tup_fetch</code>.
     */
    public final TableField<PgStatUserIndexesRecord, BigDecimal> IDX_TUP_FETCH = createField("idx_tup_fetch", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());
