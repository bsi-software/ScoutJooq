...
import com.acme.application.database.or.pg_catalog.tables.records.PgStatUserTablesRecord;
...
public class PgStatUserTables extends TableImpl<PgStatUserTablesRecord> {
    ...
    private static final long serialVersionUID = -1101757521;
     ...
     */
    public final TableField<PgStatUserTablesRecord, BigDecimal> SEQ_SCAN = createField("seq_scan", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_stat_user_tables.seq_tup_read</code>.
     */
    public final TableField<PgStatUserTablesRecord, BigDecimal> SEQ_TUP_READ = createField("seq_tup_read", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_stat_user_tables.idx_scan</code>.
     */
    public final TableField<PgStatUserTablesRecord, BigDecimal> IDX_SCAN = createField("idx_scan", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_stat_user_tables.idx_tup_fetch</code>.
     */
    public final TableField<PgStatUserTablesRecord, BigDecimal> IDX_TUP_FETCH = createField("idx_tup_fetch", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_stat_user_tables.n_tup_ins</code>.
     */
    public final TableField<PgStatUserTablesRecord, BigDecimal> N_TUP_INS = createField("n_tup_ins", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_stat_user_tables.n_tup_upd</code>.
     */
    public final TableField<PgStatUserTablesRecord, BigDecimal> N_TUP_UPD = createField("n_tup_upd", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_stat_user_tables.n_tup_del</code>.
     */
    public final TableField<PgStatUserTablesRecord, BigDecimal> N_TUP_DEL = createField("n_tup_del", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_stat_user_tables.n_tup_hot_upd</code>.
     */
    public final TableField<PgStatUserTablesRecord, BigDecimal> N_TUP_HOT_UPD = createField("n_tup_hot_upd", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_stat_user_tables.n_live_tup</code>.
     */
    public final TableField<PgStatUserTablesRecord, BigDecimal> N_LIVE_TUP = createField("n_live_tup", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_stat_user_tables.n_dead_tup</code>.
     */
    public final TableField<PgStatUserTablesRecord, BigDecimal> N_DEAD_TUP = createField("n_dead_tup", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_stat_user_tables.n_mod_since_analyze</code>.
     */
    public final TableField<PgStatUserTablesRecord, BigDecimal> N_MOD_SINCE_ANALYZE = createField("n_mod_since_analyze", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());
     ...
     */
    public final TableField<PgStatUserTablesRecord, BigDecimal> VACUUM_COUNT = createField("vacuum_count", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_stat_user_tables.autovacuum_count</code>.
     */
    public final TableField<PgStatUserTablesRecord, BigDecimal> AUTOVACUUM_COUNT = createField("autovacuum_count", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_stat_user_tables.analyze_count</code>.
     */
    public final TableField<PgStatUserTablesRecord, BigDecimal> ANALYZE_COUNT = createField("analyze_count", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_stat_user_tables.autoanalyze_count</code>.
     */
    public final TableField<PgStatUserTablesRecord, BigDecimal> AUTOANALYZE_COUNT = createField("autoanalyze_count", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());
