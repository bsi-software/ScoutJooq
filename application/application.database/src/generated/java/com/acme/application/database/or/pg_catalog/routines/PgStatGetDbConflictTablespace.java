...
public class PgStatGetDbConflictTablespace extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 261152638;
    ...
    public PgStatGetDbConflictTablespace() {
        super("pg_stat_get_db_conflict_tablespace", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
