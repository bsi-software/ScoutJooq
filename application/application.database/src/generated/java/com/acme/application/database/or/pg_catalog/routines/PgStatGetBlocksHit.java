...
public class PgStatGetBlocksHit extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1539994950;
    ...
    public PgStatGetBlocksHit() {
        super("pg_stat_get_blocks_hit", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
