...
public class Int8recv extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1194530960;
     ...
     */
    public Int8recv() {
        super("int8recv", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
