...
public class PgStatGetDbTempBytes extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1150542571;
    ...
    public PgStatGetDbTempBytes() {
        super("pg_stat_get_db_temp_bytes", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
