...
public class PgStatGetXactTuplesReturned extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -644999368;
    ...
    public PgStatGetXactTuplesReturned() {
        super("pg_stat_get_xact_tuples_returned", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
