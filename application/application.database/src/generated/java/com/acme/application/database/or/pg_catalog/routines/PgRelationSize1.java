...
public class PgRelationSize1 extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1376203794;
    ...
    public PgRelationSize1() {
        super("pg_relation_size", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
