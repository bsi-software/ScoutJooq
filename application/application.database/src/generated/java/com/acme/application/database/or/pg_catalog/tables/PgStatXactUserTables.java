...
import com.acme.application.database.or.pg_catalog.tables.records.PgStatXactUserTablesRecord;
...
public class PgStatXactUserTables extends TableImpl<PgStatXactUserTablesRecord> {
    ...
    private static final long serialVersionUID = -1381545021;
     ...
     */
    public final TableField<PgStatXactUserTablesRecord, BigDecimal> SEQ_SCAN = createField("seq_scan", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_stat_xact_user_tables.seq_tup_read</code>.
     */
    public final TableField<PgStatXactUserTablesRecord, BigDecimal> SEQ_TUP_READ = createField("seq_tup_read", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_stat_xact_user_tables.idx_scan</code>.
     */
    public final TableField<PgStatXactUserTablesRecord, BigDecimal> IDX_SCAN = createField("idx_scan", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_stat_xact_user_tables.idx_tup_fetch</code>.
     */
    public final TableField<PgStatXactUserTablesRecord, BigDecimal> IDX_TUP_FETCH = createField("idx_tup_fetch", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_stat_xact_user_tables.n_tup_ins</code>.
     */
    public final TableField<PgStatXactUserTablesRecord, BigDecimal> N_TUP_INS = createField("n_tup_ins", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_stat_xact_user_tables.n_tup_upd</code>.
     */
    public final TableField<PgStatXactUserTablesRecord, BigDecimal> N_TUP_UPD = createField("n_tup_upd", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_stat_xact_user_tables.n_tup_del</code>.
     */
    public final TableField<PgStatXactUserTablesRecord, BigDecimal> N_TUP_DEL = createField("n_tup_del", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_stat_xact_user_tables.n_tup_hot_upd</code>.
     */
    public final TableField<PgStatXactUserTablesRecord, BigDecimal> N_TUP_HOT_UPD = createField("n_tup_hot_upd", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());
