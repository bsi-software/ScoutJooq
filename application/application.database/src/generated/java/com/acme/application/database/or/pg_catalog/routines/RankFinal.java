...
public class RankFinal extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1112732926;
     ...
     */
    public RankFinal() {
        super("rank_final", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
