...
import com.acme.application.database.or.pg_catalog.tables.records.PgStatioAllSequencesRecord;
...
public class PgStatioAllSequences extends TableImpl<PgStatioAllSequencesRecord> {
    ...
    private static final long serialVersionUID = 1117901682;
     ...
     */
    public final TableField<PgStatioAllSequencesRecord, BigDecimal> BLKS_READ = createField("blks_read", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_statio_all_sequences.blks_hit</code>.
     */
    public final TableField<PgStatioAllSequencesRecord, BigDecimal> BLKS_HIT = createField("blks_hit", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());
