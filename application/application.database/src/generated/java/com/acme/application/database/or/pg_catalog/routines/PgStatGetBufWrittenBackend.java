...
public class PgStatGetBufWrittenBackend extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1219230000;
    ...
    public PgStatGetBufWrittenBackend() {
        super("pg_stat_get_buf_written_backend", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
