...
public class PgStatGetVacuumCount extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -592455451;
    ...
    public PgStatGetVacuumCount() {
        super("pg_stat_get_vacuum_count", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
