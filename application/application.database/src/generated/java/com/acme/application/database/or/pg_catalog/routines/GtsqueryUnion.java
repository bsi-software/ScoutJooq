...
public class GtsqueryUnion extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1479707192;
    ...
    public GtsqueryUnion() {
        super("gtsquery_union", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
