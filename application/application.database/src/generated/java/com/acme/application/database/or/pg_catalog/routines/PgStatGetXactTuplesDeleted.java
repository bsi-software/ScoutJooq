...
public class PgStatGetXactTuplesDeleted extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1699001716;
    ...
    public PgStatGetXactTuplesDeleted() {
        super("pg_stat_get_xact_tuples_deleted", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
