...
public class Int8abs extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1403534719;
     ...
     */
    public Int8abs() {
        super("int8abs", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
