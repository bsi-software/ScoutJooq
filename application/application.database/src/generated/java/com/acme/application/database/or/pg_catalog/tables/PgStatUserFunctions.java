...
import com.acme.application.database.or.pg_catalog.tables.records.PgStatUserFunctionsRecord;
...
public class PgStatUserFunctions extends TableImpl<PgStatUserFunctionsRecord> {
    ...
    private static final long serialVersionUID = -819202977;
     ...
     */
    public final TableField<PgStatUserFunctionsRecord, BigDecimal> CALLS = createField("calls", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());
