...
public class PgStatGetDbTuplesReturned extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 807840452;
    ...
    public PgStatGetDbTuplesReturned() {
        super("pg_stat_get_db_tuples_returned", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
