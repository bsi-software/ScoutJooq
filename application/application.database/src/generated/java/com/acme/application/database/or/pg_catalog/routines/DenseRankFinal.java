...
public class DenseRankFinal extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -473785236;
    ...
    public DenseRankFinal() {
        super("dense_rank_final", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
