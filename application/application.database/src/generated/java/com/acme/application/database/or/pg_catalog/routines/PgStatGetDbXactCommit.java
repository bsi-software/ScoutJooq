...
public class PgStatGetDbXactCommit extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 648713323;
    ...
    public PgStatGetDbXactCommit() {
        super("pg_stat_get_db_xact_commit", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
