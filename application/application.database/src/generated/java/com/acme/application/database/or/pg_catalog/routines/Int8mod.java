...
public class Int8mod extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 196836587;
     ...
     */
    public Int8mod() {
        super("int8mod", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
