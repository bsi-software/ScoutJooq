...
import com.acme.application.database.or.pg_catalog.tables.records.PgStatProgressVacuumRecord;
...
public class PgStatProgressVacuum extends TableImpl<PgStatProgressVacuumRecord> {
    ...
    private static final long serialVersionUID = -1430046893;
     ...
     */
    public final TableField<PgStatProgressVacuumRecord, BigDecimal> HEAP_BLKS_TOTAL = createField("heap_blks_total", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_stat_progress_vacuum.heap_blks_scanned</code>.
     */
    public final TableField<PgStatProgressVacuumRecord, BigDecimal> HEAP_BLKS_SCANNED = createField("heap_blks_scanned", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_stat_progress_vacuum.heap_blks_vacuumed</code>.
     */
    public final TableField<PgStatProgressVacuumRecord, BigDecimal> HEAP_BLKS_VACUUMED = createField("heap_blks_vacuumed", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_stat_progress_vacuum.index_vacuum_count</code>.
     */
    public final TableField<PgStatProgressVacuumRecord, BigDecimal> INDEX_VACUUM_COUNT = createField("index_vacuum_count", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_stat_progress_vacuum.max_dead_tuples</code>.
     */
    public final TableField<PgStatProgressVacuumRecord, BigDecimal> MAX_DEAD_TUPLES = createField("max_dead_tuples", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_stat_progress_vacuum.num_dead_tuples</code>.
     */
    public final TableField<PgStatProgressVacuumRecord, BigDecimal> NUM_DEAD_TUPLES = createField("num_dead_tuples", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());
