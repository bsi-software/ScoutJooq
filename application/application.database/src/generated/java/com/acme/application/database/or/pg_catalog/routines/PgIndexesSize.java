...
public class PgIndexesSize extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -539239459;
    ...
    public PgIndexesSize() {
        super("pg_indexes_size", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
