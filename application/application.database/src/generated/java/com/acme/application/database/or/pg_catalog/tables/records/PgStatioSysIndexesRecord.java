...
public class PgStatioSysIndexesRecord extends TableRecordImpl<PgStatioSysIndexesRecord> implements Record7<Long, Long, String, String, String, BigDecimal, BigDecimal> {

    private static final long serialVersionUID = 1245521928;
     ...
     */
    @Override
    public PgStatioSysIndexesRecord value6(BigDecimal value) {
     ...
     */
    @Override
    public PgStatioSysIndexesRecord value7(BigDecimal value) {
        setIdxBlksHit(value);
        return this;
    }
     ...
     */
    @Override
    public PgStatioSysIndexesRecord values(Long value1, Long value2, String value3, String value4, String value5, BigDecimal value6, BigDecimal value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PgStatioSysIndexesRecord(Long relid, Long indexrelid, String schemaname, String relname, String indexrelname, BigDecimal idxBlksRead, BigDecimal idxBlksHit) {
        super(PgStatioSysIndexes.PG_STATIO_SYS_INDEXES);
