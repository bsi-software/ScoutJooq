...
public class PgStatGetDbDeadlocks extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 399067363;
    ...
    public PgStatGetDbDeadlocks() {
        super("pg_stat_get_db_deadlocks", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
