...
public class PgStatGetModSinceAnalyze extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 577853452;
    ...
    public PgStatGetModSinceAnalyze() {
        super("pg_stat_get_mod_since_analyze", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
