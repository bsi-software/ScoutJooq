...
public class TsStat extends TableImpl<TsStatRecord> {
    ...
    private static final long serialVersionUID = -273758723;
     ...
     * Call this table-valued function
     */
    public TsStat call(Field<String> query, Field<String> weights) {
        return new TsStat(DSL.name(getName()), null, new Field[] { 
              query
            , weights
        });
