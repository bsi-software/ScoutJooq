...
public class Int84mul extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -873834866;
     ...
     */
    public Int84mul() {
        super("int84mul", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
