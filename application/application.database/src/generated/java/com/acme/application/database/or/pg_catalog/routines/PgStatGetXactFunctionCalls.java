...
public class PgStatGetXactFunctionCalls extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -851690493;
    ...
    public PgStatGetXactFunctionCalls() {
        super("pg_stat_get_xact_function_calls", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
