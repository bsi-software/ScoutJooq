...
public class PgStatGetDbConflictSnapshot extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 1390829698;
    ...
    public PgStatGetDbConflictSnapshot() {
        super("pg_stat_get_db_conflict_snapshot", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
