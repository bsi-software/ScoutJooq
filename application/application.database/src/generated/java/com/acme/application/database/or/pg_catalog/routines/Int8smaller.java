...
public class Int8smaller extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 424361807;
     ...
     */
    public Int8smaller() {
        super("int8smaller", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
