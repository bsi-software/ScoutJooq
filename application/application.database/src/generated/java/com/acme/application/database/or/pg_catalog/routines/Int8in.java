...
public class Int8in extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 1525858221;
     ...
     */
    public Int8in() {
        super("int8in", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
