...
import com.acme.application.database.or.pg_catalog.tables.records.PgStatSysIndexesRecord;
...
public class PgStatSysIndexes extends TableImpl<PgStatSysIndexesRecord> {
    ...
    private static final long serialVersionUID = 1247479102;
     ...
     */
    public final TableField<PgStatSysIndexesRecord, BigDecimal> IDX_SCAN = createField("idx_scan", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_stat_sys_indexes.idx_tup_read</code>.
     */
    public final TableField<PgStatSysIndexesRecord, BigDecimal> IDX_TUP_READ = createField("idx_tup_read", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_stat_sys_indexes.idx_tup_fetch</code>.
     */
    public final TableField<PgStatSysIndexesRecord, BigDecimal> IDX_TUP_FETCH = createField("idx_tup_fetch", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());
