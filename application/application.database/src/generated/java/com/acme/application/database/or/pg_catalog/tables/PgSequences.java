...
import com.acme.application.database.or.pg_catalog.tables.records.PgSequencesRecord;
...
public class PgSequences extends TableImpl<PgSequencesRecord> {
    ...
    private static final long serialVersionUID = -2076199926;
     ...
     */
    public final TableField<PgSequencesRecord, BigDecimal> START_VALUE = createField("start_value", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_sequences.min_value</code>.
     */
    public final TableField<PgSequencesRecord, BigDecimal> MIN_VALUE = createField("min_value", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_sequences.max_value</code>.
     */
    public final TableField<PgSequencesRecord, BigDecimal> MAX_VALUE = createField("max_value", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_sequences.increment_by</code>.
     */
    public final TableField<PgSequencesRecord, BigDecimal> INCREMENT_BY = createField("increment_by", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());
     ...
     */
    public final TableField<PgSequencesRecord, BigDecimal> CACHE_SIZE = createField("cache_size", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_sequences.last_value</code>.
     */
    public final TableField<PgSequencesRecord, BigDecimal> LAST_VALUE = createField("last_value", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());
