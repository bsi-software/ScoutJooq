...
import com.acme.application.database.or.pg_catalog.tables.records.PgStatioSysIndexesRecord;
...
public class PgStatioSysIndexes extends TableImpl<PgStatioSysIndexesRecord> {
    ...
    private static final long serialVersionUID = -208145473;
     ...
     */
    public final TableField<PgStatioSysIndexesRecord, BigDecimal> IDX_BLKS_READ = createField("idx_blks_read", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());

    /**
     * The column <code>pg_catalog.pg_statio_sys_indexes.idx_blks_hit</code>.
     */
    public final TableField<PgStatioSysIndexesRecord, BigDecimal> IDX_BLKS_HIT = createField("idx_blks_hit", org.jooq.impl.SQLDataType.BIGINT, this, "", new LongConverter());
