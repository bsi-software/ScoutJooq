...
public class Nextval extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 707230745;
     ...
     */
    public Nextval() {
        super("nextval", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT, new LongConverter());
